...
import HebergementNomDomaineIndex from './pages/blog/hebergement-nom-domaine/index';
...
import HebergementSiteGratuit from './pages/blog/hebergement-nom-domaine/hebergement-site-gratuit';
      ...
      <div className="min-h-screen bg-white flex flex-col">
        ...
        <main className="flex-grow">
          <Routes>
            ...
            <Route path="/hebergement-nom-domaine/hebergement-site-gratuit" element={<HebergementSiteGratuit />} />
