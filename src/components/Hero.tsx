          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              ...
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                Nous créons gratuitement des sites web professionnels pendant que vous vous concentrez sur votre activité. Aucune compétence technique requise - dites-nous simplement ce dont vous avez besoin.
              </p>
              <p className="mt-2 text-sm text-indigo-600 font-medium">
                Consultation et devis gratuits, sans engagement
              </p>
