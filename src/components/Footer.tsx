        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/outils-techniques-creation-site-web" onClick={scrollToTop} className="hover:text-white">
              ...
              <li>
                <Link to="/hebergement-nom-domaine" onClick={scrollToTop} className="hover:text-white">
