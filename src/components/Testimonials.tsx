...
const testimonials = [
  {
    ...
    content: 'WebCraft a créé un site magnifique pour ma boutique de fleurs. Les clients adorent commander en ligne et mes ventes ont augmenté de 40% !',
  },
  {
    name: 'Thomas Martin',
    role: 'Architecte',
  ...
  },
  {
    ...
    content: 'Grâce à WebCraft, nous avons un site moderne qui reflète parfaitement l\'ambiance de notre restaurant. Le système de réservation en ligne fonctionne à merveille.',
  },
];
