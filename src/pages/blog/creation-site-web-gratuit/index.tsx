    ...
    >
      ...
      <section className="mb-12">
        ...
        <div className="bg-yellow-50 p-8 rounded-xl mb-8">
          <h3 className="text-xl font-semibold mb-4">Limites et considérations</h3>
          <p className="mb-6">
            Bien que la création gratuite soit attrayante, il est important de connaître ses limites :
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Fonctionnalités limitées sur les versions gratuites</li>
            <li>Publicités potentielles sur votre site</li>
            <li>Nom de domaine personnalisé souvent payant</li>
            <li>Espace de stockage restreint</li>
