    ...
    >
      ...
      <section className="mb-12">
        ...
        <div className="bg-gray-50 p-8 rounded-xl mb-8">
          ...
          <p className="mb-6">
            Un hébergement web performant est la clé d'une expérience utilisateur réussie. Il impacte directement la vitesse de chargement de votre site, sa disponibilité et sa capacité à gérer les pics de trafic.
          </p>
          <ul className="list-disc pl-6 space-y-2 mb-6">
            <li>Performance et vitesse de chargement
